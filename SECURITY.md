...
疑似漏洞請使用 [GitHub Private Vulnerability Reporting](https://github.com/SanHsien/agent-cortex/security/advisories/new)，附上受影響 commit、最小重現、影響與已移除敏感資料的診斷資訊。完成修補前不要公開 issue、可直接利用的 PoC、token、個人路徑或 agent session 內容。
