...
目標：第一次接觸 `agent-cortex` 的使用者，能在 10 分鐘內完成安裝、bootstrap，並看到第一個 workflow 被建立與送進 manager 流程。
...
```bash
# 從 release tag
pipx install "git+https://github.com/SanHsien/agent-cortex.git@v0.1.4"
